...
class EvidenceItemResponse(BaseModel):
    ...
    category: str = Field(..., description="SOC 2 category (cc1-cc9)")
...
class ControlAssessmentResponse(BaseModel):
    ...
    control_id: str = Field(..., description="Control ID (e.g., CC6.1)")
    control_name: str = Field(..., description="Control name")
    category: str = Field(..., description="SOC 2 category")
    status: str = Field(..., description="Implementation status")
    description: str = Field(..., description="Control description")
    implementation: str = Field(..., description="How it's implemented")
...
class SOC2ExportResponse(BaseModel):
    ...
    filename: str = Field(..., description="Generated ZIP filename")
