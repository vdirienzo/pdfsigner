...
def create_signature_page(settings, dialog) -> Adw.PreferencesPage:
    ...
    visible_switch.set_title(_("Visible signature by default"))
    visible_switch.set_subtitle(_("Show signature stamp on document"))
    ...
    dimensions_group.set_title(_("Stamp dimensions"))

    # Ancho
    width_spin = Adw.SpinRow.new_with_range(20, 100, 5)
    width_spin.set_title(_("Width (mm)"))
    ...
    height_spin.set_title(_("Height (mm)"))
